    ...
    while not gameQuit:
        ...
        while not gameOver:
            ...
            if len(cacti) < 2:
                ...
                if len(pteras) == 0 and len(cacti) < 2 and random.randrange(0, 15) == 10:
                    for l in last_obstacle:
                        if l.rect.right < width * 0.7:
                            last_obstacle.empty()
                            last_obstacle.add(Ptera(gamespeed, 49, 40))
                elif not wasInsideFlag:
                    for l in last_obstacle:
